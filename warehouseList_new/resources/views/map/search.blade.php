...
<div id="mobile_navbar">
    ...
    <header>
        ...
        <br>
        <ul>
            <li><p style="margin-left:20px;"> 기존 {{$totalCount_cp_GFA_Py}}개 동 {{round(($total_cp_GFA_Py) / 1000)}} 천 평</p></li>
            <li><p style="margin-left:20px;"> 착공 {{$totalCount_ncp_GFA_Py}}개 동 {{round(($total_ncp_GFA_Py) / 1000)}} 천 평</p></li>
            <li><p style="margin-left:20px;"> 합계 {{$totalCount_GFA_Py}}개 동 {{round(($total_GFA_Py) / 1000)}} 천 평</p></li>
        </ul>
        @endif
    </div>
<section>
